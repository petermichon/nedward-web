...
import { newExplorerInputComponent } from './explorer-input.ts'

function newExplorerImportComponent(): HTMLElement {
  const e = newButtonComponent()
  e.title = 'Importer'
  {
    const eInput = newExplorerInputComponent()
...
export { newExplorerImportComponent }
